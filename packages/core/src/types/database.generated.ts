// AUTO-GENERATED by `supabase gen types typescript`. Single source of truth for
// the DB schema types; apps/web/src/lib/supabase/database.types.ts re-exports this.
// Regenerate here after migrations, do not hand-edit.

  ...
  if (!profile) {
    return (
      <div className="max-w-md mx-auto px-4 py-12 text-center">
        <p className="text-surface-300">Profile not found</p>
      </div>
    );
  }
    ...
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
      ...
      <Card>
        <div className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-surface-300 uppercase tracking-wide font-semibold">
                Handicap Index
              </p>
              <p className="text-4xl font-bold text-surface-50 mt-1">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link href="/profile/stats">
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <div className="p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-surface-50">Statistics</p>
                <p className="text-xs text-surface-300">View detailed stats</p>
              </div>
            </div>
          </Card>
        </Link>
        <Link href="/profile/handicap">
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <div className="p-4 flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-golf-900/30 flex items-center justify-center">
                <svg className="w-5 h-5 text-golf-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                </svg>
              </div>
              <div>
                <p className="text-sm font-semibold text-surface-50">Handicap</p>
                <p className="text-xs text-surface-300">Track your index</p>
              </div>
            </div>
          </Card>
        </Link>
            ...
            <div className="space-y-2">
              {recentRounds.map((round) => (
                <Link key={round.id} href={`/rounds/${round.id}/results`}>
                  <div className="flex items-center justify-between py-3 px-2 rounded-lg hover:bg-surface-700 transition-colors cursor-pointer">
                    <div>

...
export function DeleteRoundButton({ roundId, courseName, redirectTo, variant = 'button' }: Props) {
  ...
  return (
    <button
      ...
      onClick={onDelete}
      disabled={pending}
      className="inline-flex items-center gap-1.5 rounded-md border border-red-500/40 px-3 py-2 text-sm font-medium text-red-400 hover:bg-red-900/20 disabled:opacity-50"
    >
